...
const Footer = () => {
  return (
     <footer className=' max-container'>
      ...
      <div lassName='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
        ...
        <div className='flex flex-wrap justify-between flex-1 gap-20 lg:gap-10'>
            {footerLinks.map((section) => (
              ...
              <div key={section.title}>
                  <h4 lassName='font-montserrat text-2xl leading-normal font-medium mb-6 text-white'>
                      {section.title}
                  </h4>
                  <ul>
                    ...
                    {section.links.map((link) => (
                      ...
                      <li  className='mt-3 text-base leading-normal font-montserrat text-white-400 hover:text-slate-gray'
                      key={link.name}
                      >
      ...
      <div className='flex justify-between mt-24 text-white-400 max-sm:flex-col max-sm:items-center'>
           <div className='flex items-center justify-start flex-1 gap-2 cursor-pointer font-montserrat '>
             ...
             />
             <p>  Copyright 1998@nike || All right reserved</p>
           </div>
